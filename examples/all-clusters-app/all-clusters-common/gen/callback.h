...
/** @brief Fabric Cluster Init
 *
 * Cluster Init
 *
 * @param endpoint    Endpoint that is being initialized
 */
void emberAfFabricClusterInitCallback(chip::EndpointId endpoint);
...
/** @brief Fabric Cluster Server Init
 *
 * Server Init
 *
 * @param endpoint    Endpoint that is being initialized
 */
void emberAfFabricClusterServerInitCallback(chip::EndpointId endpoint);

/** @brief Fabric Cluster Server Attribute Changed
 *
 * Server Attribute Changed
 *
 * @param endpoint    Endpoint that is being initialized
 * @param attributeId Attribute that changed
 */
void emberAfFabricClusterServerAttributeChangedCallback(chip::EndpointId endpoint, chip::AttributeId attributeId);

/** @brief Fabric Cluster Server Manufacturer Specific Attribute Changed
 *
 * Server Manufacturer Specific Attribute Changed
 *
 * @param endpoint          Endpoint that is being initialized
 ...
 * @param manufacturerCode  Manufacturer Code of the attribute that changed
 */
void emberAfFabricClusterServerManufacturerSpecificAttributeChangedCallback(chip::EndpointId endpoint, chip::AttributeId attributeId, uint16_t manufacturerCode);

/** @brief Fabric Cluster Server Message Sent
 *
 * Server Message Sent
 *
 * @param type               The type of message sent
 ...
 * @param status             The status of the sent message
 */
void emberAfFabricClusterServerMessageSentCallback(EmberOutgoingMessageType type, uint64_t indexOrDestination, EmberApsFrame * apsFrame, uint16_t msgLen, uint8_t * message, EmberStatus status);

/** @brief Fabric Cluster Server Pre Attribute Changed
 *
 * server Pre Attribute Changed
 *
 * @param endpoint      Endpoint that is being initialized
 ...
 * @param value         Attribute value
 */
EmberAfStatus emberAfFabricClusterServerPreAttributeChangedCallback(chip::EndpointId endpoint, chip::AttributeId attributeId, EmberAfAttributeType attributeType, uint8_t size, uint8_t * value);

/** @brief Fabric Cluster Server Tick
 *
 * server Tick
 *
 * @param endpoint  Endpoint that is being served
 */
void emberAfFabricClusterServerTickCallback(chip::EndpointId endpoint);
...
/**
* @brief Fabric Cluster GetFabricId Command callback
*/

bool emberAfFabricClusterGetFabricIdCallback();

/**
* @brief Fabric Cluster RemoveFabric Command callback
* @param fabricId
* @param nodeId
* @param vendorId
*/
