 ...
 * Command GetFabricId
 */
PacketBufferHandle encodeFabricClusterGetFabricIdCommand(uint8_t seqNum, EndpointId destinationEndpoint)
{
    COMMAND_HEADER("GetFabricId", FABRIC_CLUSTER_ID);
      buf
        .Put8(kFrameControlClusterSpecificCommand)
       .Put8(seqNum)
       .Put8(ZCL_GET_FABRIC_ID_COMMAND_ID)
    ;
    COMMAND_FOOTER();
}
 ...
 */
PacketBufferHandle encodeFabricClusterRemoveFabricCommand(uint8_t seqNum, EndpointId destinationEndpoint, chip::FabricId fabricId, chip::NodeId nodeId, uint16_t vendorId)
{
    COMMAND_HEADER("RemoveFabric", FABRIC_CLUSTER_ID);
...
PacketBufferHandle encodeFabricClusterDiscoverAttributes(uint8_t seqNum, EndpointId destinationEndpoint)
{
    COMMAND_HEADER("DiscoverFabricAttributes", FABRIC_CLUSTER_ID);
    buf.Put8(kFrameControlGlobalCommand)
       .Put8(seqNum)
       .Put8(ZCL_DISCOVER_ATTRIBUTES_COMMAND_ID)
       .Put16(0x0000)
 ...
 */
PacketBufferHandle encodeFabricClusterReadFabricsListAttribute(uint8_t seqNum, EndpointId destinationEndpoint)
{
    COMMAND_HEADER("ReadFabricFabricsList", FABRIC_CLUSTER_ID);
    buf.Put8(kFrameControlGlobalCommand)
       .Put8(seqNum)
       .Put8(ZCL_READ_ATTRIBUTES_COMMAND_ID)
       .Put16(0x0000);
 ...
 * Attribute ClusterRevision
 */
PacketBufferHandle encodeFabricClusterReadClusterRevisionAttribute(uint8_t seqNum, EndpointId destinationEndpoint)
{
    COMMAND_HEADER("ReadFabricClusterRevision", FABRIC_CLUSTER_ID);
    buf.Put8(kFrameControlGlobalCommand)
       .Put8(seqNum)
       .Put8(ZCL_READ_ATTRIBUTES_COMMAND_ID)
       .Put16(0xFFFD);
