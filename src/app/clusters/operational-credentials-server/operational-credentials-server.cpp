...
EmberAfStatus writeFabric(FabricId fabricId, NodeId nodeId, uint16_t vendorId, uint8_t * fabricLabel, int32_t index)
{
    ...
    {
        fabricDescriptor.Label = ByteSpan(fabricLabel + 1u, emberAfStringLength(fabricLabel));
    }
